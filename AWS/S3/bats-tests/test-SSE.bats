...
EOF
  ...
  kubectl wait --timeout=5m --for=condition=Ready bucket.s3.aws.crossplane.io/encrypted-bucket-sse
  assert_success
...
EOF
  ...
  kubectl wait --timeout=5m --for=condition=Synced bucket.s3.aws.crossplane.io/encrypted-bucket-aes256
  assert_success
